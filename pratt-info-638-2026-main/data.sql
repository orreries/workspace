...
insert into books (title, publishing_year, genre_id) values ('Abaddon’s Gate', 2013, (select id from genres where name = 'Science  Fiction'));

insert into books (title, publishing_year, genre_id) values ('Columbus Day', 2016, (select id from genres where name = 'Science  Fiction'));
insert into books (title, publishing_year, genre_id) values ('SpecOps', 2016, (select id from genres where name = 'Science  Fiction'));
insert into books (title, publishing_year, genre_id) values ('Paradise', 2016, (select id from genres where name = 'Science  Fiction'));

insert into books (title, publishing_year, genre_id) values ('The Three-Body Problem', 2006, (select id from genres where name = 'Science  Fiction'));
